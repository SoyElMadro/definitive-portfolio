          ...
          {projects.map((project, index) => (
            <Card
              ...
              className={`flex flex-col overflow-hidden shadow-lg transition-all duration-300 ease-in-out ${
                ...
                project.title === "InfiniTech Studios"
            ...
            >
                    ...
                    tag === "AI" ? (
                      ...
                      <Badge
                        ...
                        className={`text-xs transition-colors duration-200 select-none ${
                          project.title === "USA2 Reventas" ||
                          project.title === "InfiniTech Studios"
                            ? "bg-accent text-white hover:text-teal-400"
                            : ""
                        }`}
                      >
                        {tag}
              ...
              <CardFooter className="mt-auto flex flex-wrap justify-start gap-3 border-t pt-4">
                ...
                >
                  {project.githubLink &&
                  project.githubLink !== "https://github.com/SoyElMadro/#" ? (
                    <Link
                ...
                {project.liveLink &&
                project.liveLink !== "https://usa2-reventa.vercel.app/" &&
                project.liveLink !== "https://infinitechstudios.vercel.app/" ? (
                  <Button
                    asChild
                    variant="ghost"
                    size="sm"
                    className="text-accent hover:text-accent hover:bg-accent/10 transition-colors duration-200 font-bold"
                  >
                    <Link
